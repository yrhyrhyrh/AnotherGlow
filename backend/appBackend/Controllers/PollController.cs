...
namespace appBackend.Controllers // Assuming Controllers namespace
{
    ...
    public class PollController : ControllerBase
    {
        ...
        public async Task<IActionResult> VoteAsync(Guid pollId, [FromBody] VoteRequest request)
        {
            ...
            try
            {
                ...
                if (request.Retract)
                {
                    await _pollService.RetractVoteAsync(pollId, authenticatedUserId); // Pass authenticated user ID
                ...
                {
                    await _pollService.CastVoteAsync(pollId, request); // Pass the whole request DTO
